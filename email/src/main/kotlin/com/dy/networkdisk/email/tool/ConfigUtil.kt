...
class ConfigUtil {
    ...
    private object SingletonHolder {
        val INSTANCE = ConfigUtil()
    }

    @PostConstruct
    private fun init() {
        SingletonHolder.INSTANCE.allowCache = allowCache
        SingletonHolder.INSTANCE.cacheExpire = cacheExpire
        SingletonHolder.INSTANCE.template = template
    }
