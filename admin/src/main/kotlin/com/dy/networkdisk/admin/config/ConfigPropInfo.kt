...
enum class ConfigPropInfo(val key: String,val default: String) {
    ...
    WEB_VERIFICATION_LENGTH("web.verification.length", "4"),
    ...
    WEB_VERIFICATION_FONT_SPACE("web.verification.font.space","5"),
